...
class PCGrad_Trainer:
    ...
    def train(
        ...
        # 正交投影
        pc_adam = PCGrad(torch.optim.Adam(optimizer_grouped_parameters))
        pc_adam.zero_grad()
        ...
        for epoch in range(epochs):
            ...
            for _ in trange(
                ...
                # 正交
                assert isinstance(loss,list), "loss should be a list"
                pc_adam.pc_backward([loss[0], loss[1]])
